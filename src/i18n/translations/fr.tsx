...
const fr: Texts = {
  ...
  "difficulty.mirror.locked": (
    <ul>
      <li>
        ...
        <strong>150cc</strong> pour débloquer le mode miroir !
      </li>
    </ul>
  ),
  ...
  "home.menu.gallery.title": "Galerie photos",
  ...
  "leaderboards.daily.not-played-yet": (date: Date) => (
    <>
      Vous n'avez pas joué au mode <i>Photos du jour</i> du{" "}
      <b>
        {new Intl.DateTimeFormat("fr-FR", {
          year: "numeric",
          month: "long",
  ...
  "photo.editCharacters.title": (
    <>Qui pouvons-nous voir sur cette photo&nbsp;?</>
  ),
  "photo.editCharacters.success":
    "Les personnages de la photo ont été mis à jour.",
  ...
  "peach.name": "Peach",
  "daisy.name": "Daisy",
  "green_yoshi.name": "Yoshi",
  "wario.name": "Wario",
  "dk.name": "Donkey Kong",
  "toad.name": "Toad",
  "king_boo.name": "Roi Boo",
  "rosalina.name": "Harmonie",
  "pauline.name": "Pauline",
  "shyguy.name": "Maskass",
  "lakitu.name": "Lakitu",
  "toadette.name": "Toadette",
  "waluigi.name": "Waluigi",
  "baby_mario.name": "Bébé Mario",
  "baby_luigi.name": "Bébé Luigi",
  "baby_peach.name": "Bébé Peach",
  "baby_daisy.name": "Bébé Daisy",
  "baby_rosalina.name": "Bébé Harmonie",
  "bowser_jr.name": "Bowser Jr.",
  "birdo.name": "Birdo",
  "nabbit.name": "Carottin",
  "cataquack.name": "Catacouac",
  "koopa_troopa.name": "Koopa Troopa",
  "piranha_plant.name": "Plante Piranha",
  "hammer_bro.name": "Frère Marto",
  "monty_mole.name": "Topi Taupe",
  "rocky_wrench.name": "Torti Taupe",
  "goomba.name": "Gomba",
  "sidestepper.name": "Zarbipas",
  "cheep_cheep.name": "Cheep Cheep",
  "dry_bones.name": "Skelerex",
  "wiggler.name": "Wiggler",
  "pokey.name": "Pokey",
  "cow.name": "Vache",
  "stingby.name": "Butitine",
  "snowman.name": "Bonhomme de neige",
  "penguin.name": "Pingouin",
  "para_biddybud.name": "Paracoccinelly",
  "spike.name": "Spike",
  "pianta.name": "Pianta",
  "conkdor.name": "Pico Condor",
  "peepa.name": "Paltrak",
  "swoop.name": "Swooper",
  "fish_bone.name": "Ossec",
  "coin_coffer.name": "Crapognon",
  "dolphin.name": "Dauphin",
  "chargin_chuck.name": "Bill Dozer",
