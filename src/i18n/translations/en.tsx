...
const en: Texts = {
  ...
  "home.menu.gallery.title": "Photo Gallery",
  ...
  "photo.editCharacters.title": <>Who can we see in this photo&nbsp;?</>,
  "photo.editCharacters.success":
    "The characters in the photo have been updated.",
  ...
  "baby_mario.name": "Baby Mario",
  "baby_luigi.name": "Baby Luigi",
  "baby_peach.name": "Baby Peach",
  "baby_daisy.name": "Baby Daisy",
  "baby_rosalina.name": "Baby Rosalina",
  "bowser_jr.name": "Bowser Jr.",
  "birdo.name": "Birdo",
  "nabbit.name": "Nabbit",
  "cataquack.name": "Cataquack",
  "koopa_troopa.name": "Koopa Troopa",
  "piranha_plant.name": "Piranha Plant",
  "hammer_bro.name": "Hammer Bro",
  "monty_mole.name": "Monty Mole",
  "rocky_wrench.name": "Rocky Wrench",
  "goomba.name": "Goomba",
  "sidestepper.name": "Sidestepper",
  "cheep_cheep.name": "Cheep Cheep",
  "dry_bones.name": "Dry Bones",
  "wiggler.name": "Wiggler",
  "pokey.name": "Pokey",
  "cow.name": "Cow",
  "stingby.name": "Stingby",
  "snowman.name": "Snowman",
  "penguin.name": "Penguin",
  "para_biddybud.name": "Para-Biddybud",
  "spike.name": "Spike",
  "pianta.name": "Pianta",
  "conkdor.name": "Conkdor",
  "peepa.name": "Peepa",
  "swoop.name": "Swoop",
  "fish_bone.name": "Fish Bone",
  "coin_coffer.name": "Coin Coffer",
  "dolphin.name": "Dolphin",
  "chargin_chuck.name": "Chargin' Chuck",
